...
(function ($) {
    $.fn.extendPagination = function (options) {
        ...
        if (totalPage > 1) {
            ...
            html.push(' <li class="previous"><a href="#001">&laquo;</a></li>');
            html.push('<li class="disabled hidden"><a href="#001">...</a></li>');
            if (totalPage <= showPage) {
                for (var i = 1; i <= totalPage; i++) {
                    if (i == 1) html.push(' <li class="active"><a href="#001">' + i + '</a></li>');
                    else html.push(' <li><a href="#001">' + i + '</a></li>');
                }
            } else {
                for (var j = 1; j <= showPage; j++) {
                    if (j == 1) html.push(' <li class="active"><a href="#001">' + j + '</a></li>');
                    else html.push(' <li><a href="#001">' + j + '</a></li>');
                }
            }
            html.push('<li class="disabled hidden"><a href="#001">...</a></li>');
            html.push('<li class="next"><a href="#001">&raquo;</a></li></ul>');
            $(this).html(html.join(''));
