...
namespace Simple
{
    ...
    public class NetUtils
    {
        ...
        {
            //创建本地终结点
            IPEndPoint localPoint = CreateIPEndPoint(NetUtils.LocalHostName, port);
        ...
        {
            //将字符串消息转换成字符数组
            byte[] buffer = Tools.StringToBytes(msg, Encoding.Default);
        ...
        public static string ReceiveMsg(Socket socket)
        {
            ...
            //转换成字符串，并将其返回
            return Tools.BytesToString(tempBuffer, Encoding.Default);
        }
        #endregion
